...
class ValidationValidatorTest extends TestCase
{
    ...
    public function testCapitalizedDisplayableValuesAreReplaced()
    {
        ...
        $v = new Validator($trans, ['url' => 'hypervel.org'], ['url' => 'starts_with:http,https']);
        $this->assertFalse($v->passes());
    ...
    public function testValidateEmailWithFilterCheck()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), ['x' => 'example@example.com'], ['x' => 'email:filter']);
        $this->assertTrue($v->passes());

        // Unicode characters are not allowed
        $v = new Validator($this->getArrayTranslator(), ['x' => 'exämple@example.com'], ['x' => 'email:filter']);
        $this->assertFalse($v->passes());

        $v = new Validator($this->getArrayTranslator(), ['x' => 'exämple@exämple.com'], ['x' => 'email:filter']);
        $this->assertFalse($v->passes());
    }
    ...
    public function testValidateEmailWithFilterUnicodeCheck()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), ['x' => 'example@example.com'], ['x' => 'email:filter_unicode']);
        $this->assertTrue($v->passes());

        // Any unicode characters are allowed only in local-part
        $v = new Validator($this->getArrayTranslator(), ['x' => 'exämple@example.com'], ['x' => 'email:filter_unicode']);
        $this->assertTrue($v->passes());

        $v = new Validator($this->getArrayTranslator(), ['x' => 'exämple@exämple.com'], ['x' => 'email:filter_unicode']);
        $this->assertFalse($v->passes());
    }
...
1',
    ...
    public function testValidateReturnsValidatedData()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), $post, ['first' => 'required', 'preferred' => 'required']);
    ...
    public function testValidateReturnsValidatedDataNestedRules()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), $post, $rules);
        $v->sometimes('type', 'required', function () {
            return false;
        });
        $data = $v->validate();
    ...
    public function testValidateReturnsValidatedDataNestedChildRules()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), $post, ['nested.foo' => 'required']);
    ...
    public function testValidateReturnsValidatedDataNestedArrayRules()
    {
        ...
        $v = new Validator($this->getArrayTranslator(), $post, ['nested.*.bar' => 'required']);
        $v->sometimes('nested.*.type', 'required', function () {
            return false;
        });
        $data = $v->validate();
    ...
    public function testValidateFailsWithAsterisksAsDataKeys()
    {
        ...
        $validator = new Validator($this->getArrayTranslator(), $post, $rules);
...
{
    protected ?string $table = 'prefix.explicits';
